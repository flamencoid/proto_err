...
\usepackage{../src/texshade/texshade}
...
\textbf{Basic Error Stats}\\
Number of reads analysed = {{numReads}} of {{totalReads}}\\
Number of SNPs per 100 bp = {{snps}}\\
Number of Deletions per 100 bp = {{del}}\\
Number of Insertions per 100 bp = {{ins}}\\
...
\begin{figure}[!htbp]
	  \centering
	  \includegraphics[width=10cm]{{{SNP_observed_expected_transition}}}
	  \caption{SNP Transitions}
	  \label{fig:SNP_observed_expected_transition}
\end{figure}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\appendix{Read Alignment}

\begin{texshade}{../results/template_last/align.msf}
% \setends{1}{1.}
\hideconsensus
\end{texshade}
